...
if($sum==0)
{
	echo "<p style='color: #fff; font-weight:bold; font-family:Montserrat;'>You should play a game first!</p>";
...
else if($sum<3)
{
	if($n==1&&$m==1)
	{
echo "<p style='color: #fff; font-weight:bold; font-family:Montserrat;'>Nice! youve done $n truths and $m dares</p>";
echo "<a href='index.html'><button type='button' class='button'>Restart</button></a>";
}
else{
	echo "<p style='color: #fff; font-weight:bold; font-family:Montserrat;'>Nice! $n truths spoken & $m dares completed</p>";
    echo "<a href='index.html'><button type='button' class='button'>Restart</button></a>";
}
}
else if($sum<5)
